...
#ifndef HELPERS_NUMERICLIMITS_CPP
#define HELPERS_NUMERICLIMITS_CPP

#define RETURN_VALUE_FN(fnName, value) static inline value_type fnName() { return value; }
...
#endif // HELPERS_NUMERICLIMITS_CPP
